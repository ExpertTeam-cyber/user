...
command -v curl > /dev/null 2>&1 || { echo >&2 "tkaya (curl) install bka bo install krdni bnusa  ./install.sh ."; exit 1; }
...
printf "\n"
read -p $'\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] atawet kam lawanay sarawa hall bzheri : \e[0m' choice
...
printf "\n"
printf "\e[1;77m888     888\n"
printf "888     888                          \n"
printf "888     888                          \n"
printf "888     888 .d8888b   .d88b.  888d888\n"
printf "888     888 88K      d8P  Y8b 888P\"  \n"
printf "888     888 \"Y8888b. 88888888 888    \n"
printf "Y88b. .d88P      X88 Y8b.     888     \n"
printf " \"Y88888P\"   88888P'  \"Y8888  888  \e[0m\n"
printf "\n"
printf "\e[1;77m v1.0\e[0m\e[1;92m  #expert\e[0m\n"
printf "\n"
}
...
read -p $'\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] listi userakan dane: \e[0m' wl_user
wl_user="${wl_user:-${default_wl_user}}"
default_threads="10"
read -p $'\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] chand chand taqi bkatawa ? (10 hallbzhera): \e[0m' threads
...
if [[ "$check" -gt 0 ]]; then
printf "\e[1;91mPlease, tkaya tor kara bka! tanha bnusa  service tor start\n\e[0m"
exit 1
fi
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] save bu: available.txt\n"
fi
